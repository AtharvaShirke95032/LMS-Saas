  ...
  return (
    ...
    >
      <div className="relative h-auto w-auto overflow-hidden">
        {/* subtle gradient mask to fade top/bottom edges */}
        <div className="pointer-events-none absolute inset-0 z-[2] h-full w-full bg-gradient-to-b from-white/60 via-transparent to-white/60 dark:from-black/60 dark:via-transparent dark:to-black/60" />
